...
// Equivalent to ScheduleCreate in Python
...
export interface SchedulePublic {
  schedule: ScheduleData;
  id: string; // uuid for now
}

export type TDataCreateSchedule = ScheduleCreate;
export type TDataReadSchedule = SchedulePublic;
